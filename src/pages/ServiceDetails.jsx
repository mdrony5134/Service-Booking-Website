            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 items-start">
                ...
                <div className="flex flex-wrap gap-4 ml-auto">
                  <button
                    type="button"
                    className="px-2.5 py-1.5 bg-pink-100 text-2xl text-pink-600 rounded-md flex items-center"
                  >
                    <svg
                      className="w-5 mr-1"
                      fill="currentColor"
              ...
              <div>
                <div className="flex flex-wrap gap-4 mt-4 md:w-2/4 w-3/4">
                  <select
                    name="hour"
                    id="hour"
