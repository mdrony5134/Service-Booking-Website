...
const Service = () => {
  ...
  return (
    <div className="lg:container mx-auto mt-6 md:pt-32 pt-20">
      <div>
        <h1 className="text-center text-4xl mb-10">All Services</h1>
      </div>
      {categories.map((category) => (
        <div className="max-w-screen-xl mx-auto">
          <h2 className="text-3xl font-bold md:mb-6 py-5 text-center md:text-start" key={category}>
            {category}
          </h2>
              ...
              .map((service) => (
                ...
                >
                  ...
                  <div className="mt-2 px-5 pb-5">
                    ...
                    <div className="flex md:justify-between md:gap-0 gap-4">
                      <button
          ...
          {cart.length > 0 ? (
            <button
              ...
              type="button"
              class="absolute md:fixed left-[49%]   md:top-[55%] md:left-[86%] inline-flex items-center px-5 py-5 text-xl font-medium text-center text-white bg-[#41B3A2]  rounded-lg hover:bg-blue-800 focus:outline-none"
            >
